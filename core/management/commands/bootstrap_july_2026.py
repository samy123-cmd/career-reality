"""
One-shot July 2026 production bootstrap: seed new content and refresh all articles.
...
class Command(BaseCommand):
    help = "Seed July 2026 articles/AI Pulse and refresh all published content."
    ...
    def handle(self, *args, **options):
        ...
        if not options["skip_seeds"]:
            for script in ("seed_july_2026.py", "seed_ai_july_2026.py"):
                path = base / script
                if not path.exists():
        ...
        self.stdout.write(self.style.SUCCESS("July 2026 bootstrap complete."))
