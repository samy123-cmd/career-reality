...
def test_guards():
    ...
    # Rationale: 90 days is structurally risky enough to never be 'Green'.
    s1 = {
    ...
    # Guard 2: Small Firm + Bond (Any) (Usually High/Med, ensure NEVER Low)
    # Even if Offer exists? 
    s2 = {
        "company_type": "small_indian",
        "role_level": "ic",
        "bond_status": "bond_unclear",
        "notice_period": "30_days", # Short notice usually helps
        "current_situation": "evaluating",
        "has_offer": "yes" # Offer usually helps
    }
